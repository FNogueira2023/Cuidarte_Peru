import '../../public/stylesheets/home/navbar.css';

function NavBar() {
    return (
        <nav className='topbar'>
            <div className='logo'>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-prescription2 topbar-icon" viewBox="0 0 16 16">
            ...
            <div className="search">
                <input type="text" className="searchTerm" placeholder="Qué estás buscando?" />
            ...
            <div className="burger-menu">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-list burger-icon" viewBox="0 0 16 16">
